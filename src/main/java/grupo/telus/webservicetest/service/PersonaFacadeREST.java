 ...
 */
package grupo.telus.webservicetest.service;

import grupo.telus.webservicetest.Persona;
 ...
 */
@Stateless
@Path("grupo.telus.webservicetest.persona")
public class PersonaFacadeREST extends AbstractFacade<Persona> {

    @PersistenceContext(unitName = "grupo.telus_WebServiceTest_war_1.0PU")
